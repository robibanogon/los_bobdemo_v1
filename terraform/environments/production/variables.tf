...
variable "domain_name" {
  type    = string
  default = "los.example.com"
}

variable "frontend_domain_name" {
  type    = string
  default = "www.los.example.com"
}

variable "api_domain_name" {
  type    = string
  default = "api.los.example.com"
}
...
variable "cors_allowed_origins" {
  type    = list(string)
  default = ["https://los.example.com", "https://www.los.example.com"]
}
