...
variable "domain_name" {
  type    = string
  default = "staging.los.example.com"
}

variable "frontend_domain_name" {
  type    = string
  default = "www.staging.los.example.com"
}

variable "api_domain_name" {
  type    = string
  default = "api.staging.los.example.com"
}
...
variable "cors_allowed_origins" {
  type    = list(string)
  default = ["https://staging.los.example.com", "https://www.staging.los.example.com"]
}
